...
const styles = {
  ...
  chipSelected: {
    ...
    justifyContent: 'center',
    whiteSpace: 'nowrap',
    boxShadow: '0 10px 26px color-mix(in srgb, var(--primary) 28%, transparent), inset 0 1px 0 rgba(255,255,255,0.40)',
  },
  billingInfo: {
    padding: '10px 12px',
    marginBottom: '8px',
  ...
  saveBtn: {
    ...
    cursor: 'pointer',
    marginTop: '20px',
    boxShadow: '0 14px 34px rgba(16, 24, 40, 0.18), inset 0 1px 0 rgba(255,255,255,0.28)',
  },
}
